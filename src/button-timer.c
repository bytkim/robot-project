...
#pragma config(Sensor, dgtl1,  testButton,     sensorTouch)
#pragma config(Sensor, dgtl3,  dgtlLimitSwitch, sensorTouch)
...
#pragma config(Motor,  port8,           armLeft,       tmotorVex269_MC29, openLoop)
#pragma config(Motor,  port9,           armRight,      tmotorVex269_MC29, openLoop)
#pragma config(Motor,  port10,          leftMotor,     tmotorVex393_HBridge, openLoop, reversed)
//*!!Code automatically generated by 'ROBOTC' configuration wizard               !!*//

// Global Variables
int freq, ambient_level, slow_level, stop_level, expose_time, steer_sensitivity, forward_speed, slow_speed, spin_speed, arm_speed;
...
int max_val, max_no, elapsedMs, max_sonar_distance = 0;
...
task main() {
	...
	while (current_state == FIND_RED_BEACON) {
	...
	while(current_state == GO_TO_GREEN_BEACON){
